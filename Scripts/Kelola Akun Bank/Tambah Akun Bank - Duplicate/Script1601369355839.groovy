...
Mobile.setText(findTestObject('Kelola Akun Bank Repo/android.widget.EditText0 - Masukkan nomor rekening'), '123456', 0)

Mobile.setText(findTestObject('Kelola Akun Bank Repo/android.widget.EditText0 - Masukkan nama yang diinginkan'), 'Awan',
	0)
...
Mobile.tap(findTestObject('Kelola Akun Bank Repo/android.widget.TextView0 - OK'), 0)
