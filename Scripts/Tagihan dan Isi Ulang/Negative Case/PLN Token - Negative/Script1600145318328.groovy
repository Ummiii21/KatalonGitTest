...
Mobile.setText(findTestObject('PLN Token Repo/android.widget.EditText0 - Masukkan Nomor Pelanggan'), '00000', 0)
...
Mobile.tap(findTestObject('PLN Token Repo/android.widget.TextView0 - OK'), 0)

//Mobile.tap(findTestObject('PLN Token Repo/android.widget.ImageButton0'), 0)

Mobile.setText(findTestObject('PLN Token Repo/android.widget.EditText0 - 00000000000'), '56709856902', 0)
