...
Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.TextView0 - Tagihan  Isi Ulang'), 0)

Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.TextView0 - PLN'), 0)

Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.TextView0 - Tagihan'), 0)

Mobile.setText(findTestObject('PLN Tagihan Repo/android.widget.EditText0 - Masukkan Nomor Pelanggan'), '56709856902', 0)

Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.Button0 - Next'), 0)

Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.Button0 - Pay'), 0)
...
Mobile.setText(findTestObject('Paket Data Repo/android.widget.EditText0'), '000000', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setEncryptedText(findTestObject('PLN Tagihan Repo/android.widget.EditText0'), 'aeHFOx8jV/A=', 0)
...
Mobile.setText(findTestObject('PLN Tagihan Repo/android.widget.EditText0 (1)'), '000000', 0)

Mobile.tap(findTestObject('PLN Tagihan Repo/android.widget.Button0 - Submit'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('PLN Tagihan Repo/android.widget.EditText0 (1)'), parsedJson.otp, 0)
