...
Mobile.tap(findTestObject('PayTV Repo/android.widget.TextView0 - Tagihan  Isi Ulang'), 0)

Mobile.tap(findTestObject('PayTV Repo/android.widget.TextView0 - PayTV'), 0)

Mobile.tap(findTestObject('PayTV Repo/android.widget.LinearLayout0'), 0)

Mobile.setText(findTestObject('PayTV Repo/android.widget.EditText0 - Masukkan Nomor Pelanggan'), '401001511593', 0)

Mobile.tap(findTestObject('PayTV Repo/android.widget.Button0 - Next'), 0)

Mobile.tap(findTestObject('PayTV Repo/android.widget.Button0 - Pay (1)'), 0)

Mobile.setEncryptedText(findTestObject('PayTV Repo/android.widget.EditText0'), '5WbaaGOlRjI=', 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('PayTV Repo/android.widget.EditText0 (1)'), 0)

Mobile.setEncryptedText(findTestObject('PayTV Repo/android.widget.EditText0 (2)'), 'aeHFOx8jV/A=', 0)

Mobile.setText(findTestObject('PayTV Repo/android.widget.EditText0 (3)'), '000000', 0)

Mobile.tap(findTestObject('PayTV Repo/android.widget.Button0 - Submit'), 0)
...
Mobile.setText(findTestObject('PayTV Repo/android.widget.EditText0 (3)'), parsedJson.otp, 0)
