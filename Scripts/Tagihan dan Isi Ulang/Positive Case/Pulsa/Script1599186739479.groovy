...
Mobile.tap(findTestObject('Pulsa Repo/android.widget.TextView0 - Tagihan  Isi Ulang'), 0)

Mobile.tap(findTestObject('Pulsa Repo/android.widget.TextView0 - Pulsa'), 0)

Mobile.setText(findTestObject('Pulsa Repo/android.widget.EditText0 - Masukkan Nomor Telepon'), '082114112515', 0)

Mobile.tap(findTestObject('Pulsa Repo/android.widget.Button0 - Next'), 0)

Mobile.tap(findTestObject('Pulsa Repo/android.widget.TextView0 - Telkomsel 10.000'), 0)

Mobile.tap(findTestObject('Pulsa Repo/android.widget.Button0 - Pay'), 0)
...
Mobile.setEncryptedText(findTestObject('Pulsa Repo/android.widget.EditText0'), 'aeHFOx8jV/A=', 0)
...
Mobile.setText(findTestObject('Pulsa Repo/android.widget.EditText0 (1)'), parsedJson.otp, 0)

Mobile.tap(findTestObject('Pulsa Repo/android.widget.Button0 - Submit'), 0)
