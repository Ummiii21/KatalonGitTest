...
Mobile.setText(findTestObject('Telkom Repo/android.widget.EditText0 - Masukkan Nomor Telepon'), '02187986233', 0)

Mobile.tap(findTestObject('Telkom Repo/android.widget.Button0 - Next'), 0)

Mobile.tap(findTestObject('Telkom Repo/android.widget.Button0 - Pay'), 0)
...
Mobile.setEncryptedText(findTestObject('Telkom Repo/android.widget.EditText0 (2)'), 'aeHFOx8jV/A=', 0)
...
Mobile.setText(findTestObject('Telkom Repo/android.widget.EditText0 (3)'), parsedJson.otp, 0)
